          ...
          <form action="" className="text-center">
            <div className="grid grid-rows-2 justify-items-center items-center gap-y-6">
              <input
                type="text"
                name="username"
                className="ease-in-out duration-300 w-full p-4 rounded-xl bg-mpGrey bg-opacity-10 border-1 border-slate-300 text-sm md:text-base lg:text-lg italic placeholder:italic placeholder:text-black"
